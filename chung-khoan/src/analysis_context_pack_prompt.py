...
def normalize_analysis_context_pack_language(report_language: str = "zh") -> str:
    # Korean & Vietnamese reuse the English structural context labels; the model is
    # constrained to Korean/Vietnamese output via the analysis output-language directive.
