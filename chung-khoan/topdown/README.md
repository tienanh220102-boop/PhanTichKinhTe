...
| `vn_notes.py` | Đọc THUYẾT MINH BCTC (PDF BCTN, nguồn CDN Vietstock keyless): giao dịch/số dư BÊN LIÊN QUAN + dò tuổi nợ/tập trung KH/trái phiếu/mảng |
| `vn_telegram.py` | Gửi tin Telegram (tự chunk >4096) |

_Công cụ hỗ trợ đọc, KHÔNG phải khuyến nghị mua/bán. Giả định r/g THEO NGÀNH (bảng `SECTOR_RG` trong `vn_valuation.py`; mặc định 13%/5%)._
